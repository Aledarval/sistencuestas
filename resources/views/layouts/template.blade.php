<html>
    ...
    @section('menu')
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="{{route('empresa.index')}}">Empresa <span class="sr-only">(current)</span></a>@show
                </li>
                <li class="nav-item">
        ...
        @section('menu')
            ...
            <a href="{{route('empresa.index')}}">Configuraciones</a>
             <li> 
            <a href="{{route('empresa.index')}}">Reportes</a>
            @show
            <br/>
            <br/>
